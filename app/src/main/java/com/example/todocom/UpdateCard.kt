...
class UpdateCard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        createDescription = findViewById(R.id.update_description)
            ...
            updateButton.setOnClickListener {
                ...
                GlobalScope.launch {
                    dataBase.dao().updateTask(
                        Entity(pos+1, createTitle.text.toString(), createPriority.text.toString(), createDescription.text.toString())
                    )
                }
